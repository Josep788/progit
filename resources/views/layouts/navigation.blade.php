        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('saki.listaractores')" :active="request()->routeIs('saki.listaractores')">
                        {{ __('Listado de actores') }}
                    </x-nav-link>
                    <x-nav-link :href="route('saki.crearactores')" :active="request()->routeIs('saki.crearactores')">
                        {{ __('Nuevos actores') }}
                    </x-nav-link>
                    <x-nav-link :href="route('saki.listarpelis')" :active="request()->routeIs('saki.listarpelis')">
                        {{ __('Listado de peliculas') }}
                    </x-nav-link>
                    <x-nav-link :href="route('saki.crearpelis')" :active="request()->routeIs('saki.crearpelis')">
                        {{ __('Nuevas peliculas') }}
                    </x-nav-link>
                    <x-nav-link :href="route('saki.consultas')" :active="request()->routeIs('saki.consultas')">
                        {{ __('Consultas sobre sakila') }}
                    </x-nav-link>
                    <x-nav-link :href="route('saki.files')" :active="request()->routeIs('saki.files')">
                        {{ __('Subir archivos') }}
                    </x-nav-link>
                </div>
            </div>
